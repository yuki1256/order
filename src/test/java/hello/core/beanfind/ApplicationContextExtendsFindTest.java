...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypesDuplicate() {
        assertThrows(NoUniqueBeanDefinitionException.class,
                () -> ac.getBean(DiscountPolicy.class));
    }

    @Test
    @DisplayName("부모 타입으로 조회시, 자식이 둘 이상 있으면, 당연히 빈 이름으로 조회하면 됨")
    void findBeanByName() {
    ...
    @Test
    @DisplayName("특정 하위 타입으로 조회 (별로 안좋은 방식)")
